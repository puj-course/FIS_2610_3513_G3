...
| Milestone | Estado |
|------------|---------|
| Versión 1.0 - Entregar Documentación | open |
| Modulo Inicio de Sesión, dockerizar y conectar base de datos, DDL | open |
| Creación de roles en Trabajos | open |
| Implementar patrones GoF | open |
| Sprint: Edición, comunicación y visualización de trabajos y tareas | open |
| Segunda Entrega | open |
| Calidad y métricas | open |
